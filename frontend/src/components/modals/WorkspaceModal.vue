 ...
 * 
 * Provides custom styling for the workspace modal while maintaining
 * Bootstrap compatibility and ensuring good user experience.
 */

/**
 * Modal dialog sizing
 * Uses large modal size to accommodate all form fields comfortably
 */
.modal-dialog {
  max-width: 600px;
}
 ...
 * Creates a subtle preview section that shows how the workspace will appear
 */
.card.bg-light {
...
/**
 * Form text styling
 * Ensures help text is readable and properly spaced
 */
.form-text {
  font-size: 0.875rem;
 ...
 * Makes the currency preview more prominent
 */
.badge.bg-primary {
  font-size: 0.875rem;
 ...
 * Ensures proper spacing when loading spinner is shown
 */
.spinner-border-sm {
  width: 1rem;
  height: 1rem;
